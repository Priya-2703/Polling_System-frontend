    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          animation: isClosing
            ? "suggestionBackdropOut 0.35s ease-out forwards"
            : "suggestionBackdropIn 0.3s ease-out forwards",
        }}
      >
        {/* Backdrop with blur */}
        ...
        <div
          className="relative z-10 w-[90%] sm:w-[90%] md:w-[80%] lg:w-[55%] xl:w-[45%] max-w-xl mx-auto"
          style={{
            maxHeight: "calc(100dvh - 40px)",
            animation: isClosing
              ? "suggestionPopupOut 0.35s cubic-bezier(0.4, 0, 0.2, 1) forwards"
              : "suggestionPopupIn 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) forwards",
          ...
          <div className="relative bg-gradient-to-b from-[#0d0d18] via-[#080810] to-[#0d0d18] border border-accet/50 rounded-xl shadow-[0_0_30px_rgba(0,243,255,0.3)] overflow-hidden">
            ...
            <div 
              ...
              style={{ 
                ...
                animation: isClosing ? "none" : "suggestionContentFadeIn 0.5s ease-out 0.2s both"
              }}
            >
              ...
              {submitSuccess ? (
                <div 
                  ...
                  style={{ animation: "successScale 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)" }}
                >
                  ...
                  <p className="text-sm text-white/60 font-body text-center max-w-xs">
                    Your valuable suggestion has been submitted successfully.
                  </p>
                ...
                <>
                  ...
                  <div className="relative mb-5">
                    <div 
                      className={`absolute -inset-1 bg-linear-to-r from-accet via-cyan-400 to-accet rounded-xl blur-md transition-all duration-500 ${
                        isFocused ? "opacity-10" : "opacity-0"
                      }`}
                    />
                    
                    <div className={`relative border rounded-lg transition-all duration-300 overflow-hidden ${
                      isFocused 
                      ...
                      <div className="flex items-center justify-between px-3 md:px-4 py-2 md:py-3 border-b border-white/10 bg-white/5">
                        ...
                        <svg className={`w-3.5 h-3.5 md:w-4 md:h-4 transition-colors duration-300 ${isFocused ? "text-accet" : "text-white/30"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="flex items-center justify-between px-4 py-2 md:py-3 border-t border-white/10 bg-black/30">
                        <div className="flex items-center gap-3">
                          <div className="h-1 lg:h-1.5 bg-white/10 rounded-full overflow-hidden" style={{ width: "80px" }}>
                            <div 
                              className={`h-full rounded-full transition-all duration-500 ${
                                wordCount >= MAX_WORDS 
                                  ...
                                  : wordCount >= MAX_WORDS * 0.8 
                                    ...
                                    : "bg-linear-to-r from-accet to-cyan-400"
                              }`}
                        ...
                        <div className={`flex items-center gap-1.5 px-2 py-1 rounded border transition-all duration-300 ${
                          ...
                          <span className="text-[8px] md:text-[10px] font-num">{wordCount}</span>
                          <span className="text-[8px] md:text-[10px] font-num text-white/30">/ {MAX_WORDS}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <button
                      ...
                      className={`flex-1 py-2 lg:py-3.5 px-5 rounded-lg font-heading font-semibold uppercase text-[10px] md:text-xs tracking-wider transition-all duration-300 flex items-center justify-center gap-1 md:gap-2 ${
                        suggestionText.trim() && !isSubmitting
                          ? "bg-linear-to-r from-accet via-accet to-cyan-500 text-black shadow-[0_0_10px_rgba(0,243,255,0.4)] hover:shadow-[0_0_35px_rgba(0,243,255,0.6)] hover:scale-[1.02] active:scale-[0.98]"
