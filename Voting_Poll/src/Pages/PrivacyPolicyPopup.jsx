// src/Pages/PrivacyPolicyPopup.jsx
        ...
        >
          ...
          <div
            ...
            style={{
              boxShadow: isAnimating
                ? "0 0 30px rgba(76, 67, 221, 0.3), inset 0 0 30px rgba(76, 67, 221, 0.1)"
                : "none",
            }}
          />
          ...
          <div className="overflow-y-auto max-h-[95vh] sm:max-h-[90vh] custom-scrollbar">
            ...
            >
              <section className="w-full max-w-4xl mx-auto pb-5 md:pb-8">
                ...
                <div className="flex items-center gap-2 md:gap-3 mb-1 md:mb-5">
                  ...
                  <div>
                    <h1 className="font-heading text-lg md:text-4xl lg:text-5xl font-bold flex justify-center items-center gap-2 md:gap-3 tracking-tight text-white leading-none">
                      <span className="text-glow">
                        {t("privacy.hero.title1")}
                      </span>
                      <span className="text-glow text-transparent bg-clip-text bg-linear-to-r from-accet via-cyan-400 to-accet leading-19">
                ...
                <div className="relative md:mb-1">
                  <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-linear-to-b from-accet via-accet/40 to-accet/10 rounded-full" />
            ...
            <section className="w-full px-4 sm:px-6 md:px-10 pb-8 md:pb-16">
              ...
              {/* Key Highlights */}
              <div
                className={`max-w-4xl mx-auto mt-8 md:mt-16 grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6 transition-all duration-500 ${
                  isAnimating
                    ? "opacity-100 translate-y-0"
              ...
              >
                <div className="glass-panel p-5 md:p-6 rounded-sm border border-green-500/30 text-center">
                  <Icon
                    ...
                    width={28}
                  />
                  <h4 className="font-heading text-xs md:text-sm text-white mb-2">
                    {t("privacy.highlights.noSharing.title")}
                  </h4>
                ...
                <div className="glass-panel p-5 md:p-6 rounded-sm border border-blue-500/30 text-center">
                  ...
                  />
                  <h4 className="font-heading text-xs md:text-sm text-white mb-2">
                    {t("privacy.highlights.deletion.title")}
                  </h4>
                  <p className="text-[8px] md:text-[11px] text-neutral-500">
                ...
                <div className="glass-panel p-5 md:p-6 rounded-sm border border-purple-500/30 text-center">
                  ...
                  />
                  <h4 className="font-heading text-xs md:text-sm text-white mb-2">
                    {t("privacy.highlights.anonymized.title")}
                  </h4>
                  <p className="text-[8px] md:text-[11px] text-neutral-500">
              ...
              >
                ...
                <div className="relative z-10 text-center">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-accet hover:text-cyan-300 transition-colors font-heading text-sm md:text-base tracking-wide"
                  >
